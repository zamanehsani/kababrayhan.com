    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-sm relative">
        ...
        <div className="flex flex-col gap-4">
          <button
            className="w-full rounded-xl bg-brand-400 py-3 text-base font-black uppercase tracking-widest text-white transition-all hover:bg-brand-700 active:scale-[0.98]"

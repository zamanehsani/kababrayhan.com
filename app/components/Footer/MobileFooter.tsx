    ...
    <footer className="bg-slate-900 text-slate-100 pt-8 pb-20">
      <div className="px-4">
        ...
        <div className="mb-6 space-y-3">
          ...
          <div className="flex items-start gap-3 text-sm">
            <Clock size={18} className="text-brand-400 mt-0.5 shrink-0" />
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-center gap-4">
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:bg-brand-400 hover:text-slate-900 transition-all"
              aria-label="Facebook"
            >

 ...
 return (
    ...
    */
    <section className="mt-10 px-8">
      <div className="relative overflow-visible rounded-[32px] bg-red-600 p-10 text-white shadow-xl shadow-red-100/30 min-h-[240px] flex items-center justify-between">

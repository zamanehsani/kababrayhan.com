      ...
      <main className="mx-auto max-w-7xl px-6 py-10 md:py-14 lg:py-16">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-start flex flex-col md:flex-col lg:flex-row">
          ...
          <div className="space-y-8 order-2 lg:order-1">
            ...
            <div className="rounded-2xl border border-stone-100 bg-white shadow-sm overflow-hidden lg:border-none lg:bg-transparent lg:shadow-none">
              <button 
                type="button"
                onClick={() => setIsAddressCollapsed(!isAddressCollapsed)}
                className="flex w-full items-center justify-between px-4 py-4 bg-stone-50 text-left font-medium text-stone-800 lg:hidden"
              >
                <span className="text-sm font-semibold tracking-wide uppercase text-stone-600">
                  {isAddressCollapsed ? "▼ Show Delivery Details" : "▲ Hide Delivery Details"}
                </span>
          ...
          <div className="lg:sticky lg:top-24 order-1 lg:order-2">
            ...
            <div className="rounded-2xl border border-stone-100 bg-white shadow-sm overflow-hidden lg:border-none lg:bg-transparent lg:shadow-none">
              ...
              >
                <span className="text-sm font-semibold tracking-wide uppercase text-stone-600">
                  {isSummaryCollapsed ? "▼ Show Order Summary" : "▲ Hide Order Summary"}
                </span>
              ...
              <div className={`${isSummaryCollapsed ? "hidden lg:block" : "block"} px-2 py-4 lg:p-0`}>
